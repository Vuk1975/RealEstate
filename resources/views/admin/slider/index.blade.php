                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    @if(count($sliders)>0)
                      ...
                      <tr>
                        ...
                        <td><img src="{{url('/images/slider/'.$slider->img)}}" width="100"></td>
                        <td>{{$slider->titleTop}}</td>
                        <td>{{$slider->introTitleTop}}</td>
                        <td>{{$slider->introSubtitle}}</td>
                        <td>{{$slider->introLink}}</td>
                        <td>
