...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 ml-4 text-gray-800">Blog post</h1>
            <ol class="breadcrumb">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-10">
        <form action="{{route('blogpost.update',[$blogpost->id])}}" method="POST" enctype="multipart/form-data">@csrf
        	{{method_field('PUT')}}
              <div class="card mb-6">
                ...
                <div class="card-body">
                    <div class="form-group"> 
                      ...
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror " id="" aria-describedby=""
                        placeholder="Enter name of Blog Post" value="{{$blogpost->name}}">
                        @error('name')
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label>
                                                <img src="{{asset('/images/properties/'.$blogpost->img)}}" alt="..." class="img-thumbnail img-check">
                                            </div>
                                            <hr>
                                        </div>
